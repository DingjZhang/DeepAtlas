...
sed -i "s|GLOBAL_NGINX_FRONTEND_URL|GLOBAL_NGINX_FRONTEND_URL = '$nginx_thrift_url'|g" ./locust/locustfile.py
sed -i "s|GLOBAL_MEDIA_FRONTEND_URL|GLOBAL_MEDIA_FRONTEND_URL = '$media_frontend_url'|g" ./locust/locustfile.py